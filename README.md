<p align="center">
  ...
  <p align="center">
    <a href="https://www.npmjs.com/package/@michael-3-141/react-pdf-renderer">
      <img src="https://img.shields.io/npm/v/@michael-3-141/react-pdf-renderer.svg" />
    </a>
...
## How to install
```sh
yarn add @michael-3-141/react-pdf-renderer
```
...
import { Document, Page, Text, View, StyleSheet } from '@michael-3-141/react-pdf-renderer';
...
import { PDFViewer } from '@michael-3-141/react-pdf-renderer';
...
```jsx
import React from 'react';
import ReactPDF from '@michael-3-141/react-pdf-renderer';
...
---
![](https://img.shields.io/npm/dt/@michael-3-141/react-pdf-renderer.svg?style=flat)
